...
databaseChangeLog(logicalFilePath: 'script/db/fd_custom_chart.groovy') {
    changeSet(author: "chihao.ran@hand-china.com", id: "2021-06-23-fd-custom-chart"){
        createTable(tableName: "fd_custom_chart", remarks: "自定义报表") {
            ...
            column(name: "name", type: "VARCHAR(255)",  remarks: "自定义报表名称")  {constraints(nullable:"false")}  
            column(name: "description", type: "VARCHAR(255)",  remarks: "自定义报表描述")   
            column(name: "analysis_field", type: "VARCHAR(255)",  remarks: "分析维度参数")  {constraints(nullable:"false")}  
            column(name: "analysis_field_predefined", type: "TINYINT(1)",  remarks: "分析维度参数是否为预定义")  {constraints(nullable:"false")}
            ...
            column(name: "statistics_type", type: "VARCHAR(255)",  remarks: "统计项类型")  {constraints(nullable:"false")}  
            column(name: "chart_type", type: "VARCHAR(255)",  remarks: "自定义报表图表类型")  {constraints(nullable:"false")}  
