...
//    private Boolean enabled;
    ...
    @ApiModelProperty(value = "发布火车工程师")
    @Transient
    private UserMessageDTO rte;
...
//    }
    ...
    public UserMessageDTO getRte() {
        return rte;
    }

    public void setRte(UserMessageDTO rte) {
        this.rte = rte;
    }
    ...
    public Long getSpecifyPiId() {
        return specifyPiId;
    }

    public void setSpecifyPiId(Long specifyPiId) {
        this.specifyPiId = specifyPiId;
    }
}
