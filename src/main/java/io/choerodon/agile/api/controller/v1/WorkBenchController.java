...
public class WorkBenchController {
    ...
    @ApiOperation(value = "分页查询权限项目下问题类型列表")
    @GetMapping("/issue_types")
    public ResponseEntity<Page<IssueTypeVO>> queryUserProjectIssueTypes(@ApiIgnore
        ...
        return ResponseEntity.ok(issueTypeService.queryUserProjectIssueTypes(pageRequest, organizationId, name, type));
    }
