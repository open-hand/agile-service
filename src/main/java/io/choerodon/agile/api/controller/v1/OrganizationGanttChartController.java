...
public class OrganizationGanttChartController {
    ...
    public ResponseEntity<List<ProjectVO>> listAgileProjects(@ApiParam(value = "组织id", required = true)
                                                             ...
                                                             @ApiParam(value = "模糊查询参数", required = true)
    ...
    public ResponseEntity<List<AgileIssueHeadVO>> getIssueHeaderFields(@ApiParam(value = "组织id", required = true)
                                                                       @PathVariable(name = "organization_id") Long organizationId,
    ...
    public ResponseEntity<List<ObjectSchemeFieldDetailVO>> listCustomFields(@ApiParam(value = "组织id", required = true)
                                                                            @PathVariable(name = "organization_id") Long organizationId) {
