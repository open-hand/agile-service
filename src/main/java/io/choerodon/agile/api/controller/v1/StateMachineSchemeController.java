...
public class StateMachineSchemeController {
    ...
    public ResponseEntity<Boolean> delete(@PathVariable("organization_id") Long organizationId, @PathVariable("scheme_id") @Encrypt/*(EncryptionConstant.FD_STATE_MACHINE_SCHEME)*/ Long schemeId) {
    ...
    public ResponseEntity<StateMachineSchemeVO> querySchemeWithConfigById(@PathVariable("organization_id") Long organizationId, @PathVariable("scheme_id") @Encrypt/*(EncryptionConstant.FD_STATE_MACHINE_SCHEME)*/ Long schemeId, @RequestParam("isDraft") Boolean isDraft) {
    ...
    public ResponseEntity<StateMachineSchemeVO> deleteConfig(@PathVariable("organization_id") Long organizationId,
                                                             @PathVariable("scheme_id")  @Encrypt/*(EncryptionConstant.FD_STATE_MACHINE_SCHEME)*/ Long schemeId,
                                                             @PathVariable("state_machine_id") @Encrypt/*(EncryptionConstant.FD_STATE_MACHINE)*/ Long stateMachineId) {
    ...
    public ResponseEntity<StateMachineSchemeVO> deleteDraft(@PathVariable("organization_id") Long organizationId,
                                                            @PathVariable("scheme_id") @Encrypt/*(EncryptionConstant.FD_STATE_MACHINE_SCHEME)*/ Long stateMachineId) {
