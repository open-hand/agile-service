...
//        epicMap.put(FieldCode.INFLUENCE_VERSION, new PageConfigFieldEditedVO(false, true, true));
        ...
        storyMap.put(FieldCode.APP_VERSION, new PageConfigFieldEditedVO(false, false, false));
...
//        storyMap.put(FieldCode.COMPONENT, new PageConfigFieldEditedVO(false, true, true));
        ...
        taskMap.put(FieldCode.APP_VERSION, new PageConfigFieldEditedVO(false, false, false));
...
//        taskMap.put(FieldCode.COMPONENT, new PageConfigFieldEditedVO(false, true, true));
        ...
        bugMap.put(FieldCode.APP_VERSION, new PageConfigFieldEditedVO(false, false, false));
