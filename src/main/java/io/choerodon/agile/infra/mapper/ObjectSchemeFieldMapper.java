...
public interface ObjectSchemeFieldMapper extends BaseMapper<ObjectSchemeFieldDTO> {
    ...
    List<ObjectSchemeFieldDetailVO> selectCustomFieldList(@Param("organizationId") Long organizationId, @Param("projectId") Long projectId, @Param("issueType") String issueType);
