...
public class SendMsgUtil {
    ...
    @Async
    public void sendMsgByWorkLogDelete(Long projectId, IssueDetailDTO issue, WorkLogDTO workLog, CustomUserDetails deleteUser) {
        siteMsgUtil.workLogDelete(projectId, issue, workLog, deleteUser);
    }
