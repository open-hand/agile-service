...
const TestLink = observer(({
  ...
  const onOpen = (caseId) => {
    ...
    history.push(`/testManager/IssueManage/testCase/${caseId}?type=${urlParams.type}&id=${urlParams.id}&name=${encodeURIComponent(urlParams.name)}&organizationId=${urlParams.organizationId}&orgId=${urlParams.organizationId}`);
  };
