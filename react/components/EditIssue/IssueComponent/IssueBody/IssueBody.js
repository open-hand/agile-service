  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      if (outside) {
        ...
        Data = store.projectId?.toString() !== projectId.toString() ? await featureApi.project(store.projectId).getSubProjectSplitStory(issueId, projectId) : await featureApi.getSplitStory(issueId);
      }
