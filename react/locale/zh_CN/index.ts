...
const zh_CN = {
  ...
  'stateMachineScheme.edit': '修改状态机方案',
  ...
  'stateMachineScheme.tips': '注意：此状态机方案正在被使用。你正在修改 #状态机方案草稿# ，如果修改后的草稿需要生效，点击 #发布# 。',
  ...
  'stateMachineScheme.draft': '修改草稿',
  'stateMachineScheme.delete.draft': '删除状态机草稿',
  'stateMachineScheme.delete.des': '确实要删除当前修改的状态机草稿吗？',
  ...
  'stateMachine.transfer.edit': '修改转换',
  ...
  'stateMachine.edit.draft.tip': '注意：此状态机正在被使用。你正在修改 状态机草稿 ，如果修改后的草稿需要生效，请点击 发布 。删除草稿 后草稿备份为现在正在使用的状态机。',
  'stateMachine.edit.deploy.tip': '注意：此状态机正在被使用。如果你需要修改，请点击 修改 。',
