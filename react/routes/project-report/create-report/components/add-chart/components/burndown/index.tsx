...
import BurnDown, { BurnDownProps, IBurndownChartType } from '@/components/charts/burn-down';
import BurnDownSearch, { BurnDownSearchProps } from '@/components/charts/burn-down/search';
...
function useBurnDownReport(): [BurnDownSearchProps, BurnDownProps] {
  ...
  const [type, setType] = useState<IBurndownChartType>('remainingEstimatedTime');
