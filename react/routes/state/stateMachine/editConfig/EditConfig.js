...
class EditConfig extends Component {
  ...
  handleEdit = (state) => {
    ...
    history.push(`/agile/states/state-machine/${machineId}/editconfig/select/${state}/${configId}?type=organization&id=${id}&name=${encodeURIComponent(name)}&organizationId=${organizationId}&orgId=${organizationId}`);
  };
  ...
  handleStateClick = (stateId) => {
    ...
    if (sId) {
      history.push(`/agile/states/state-machine/${machineId}/editconfig/${stateId}?type=organization&id=${id}&name=${encodeURIComponent(name)}&organizationId=${organizationId}&orgId=${organizationId}`);
    } else {
      history.push(`/agile/states/state-machine/${machineId}/editconfig/${transferId}/state/${stateId}?type=organization&id=${id}&name=${encodeURIComponent(name)}&organizationId=${organizationId}&orgId=${organizationId}`);
    }
  };
    ...
    return (
      <Page>
        <Header
          ...
          backPath={stateId ? `/agile/states/state-machine/${machineId}/editconfig/${transferId}?type=${type}&id=${projectId}&name=${encodeURIComponent(name)}&organizationId=${orgId}&orgId=${orgId}` : `/agile/states/state-machine/edit/${machineId}/${stateMachineData.status}?type=${type}&id=${projectId}&name=${encodeURIComponent(name)}&organizationId=${orgId}&orgId=${orgId}`}
        >
          <Button
